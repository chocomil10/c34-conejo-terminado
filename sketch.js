...
var eating_sound;
var starimg;
var star1,star2,empty,starDisplay;
function preload()
{
  ...
  star2Img = loadAnimation("estrella.png");
  blink.playing = true;
  eat.playing = true;
  sad.playing = true;
  sad.looping= false;
...
globo.mouseClicked(aire);
  ...
  starDisplay.addAnimation('empty1',empty);
  starDisplay.addAnimation('one',star1);
  starDisplay.addAnimation('estrella',star2Img);
  starDisplay.changeAnimation('empty1');
...
function draw() 
{
  ...
  if(fruit!=null && fruit.position.y>=650)
  {
   ...
   if(collide(fruit,star2,20)==true){
    star2.visible = false;
    starDisplay.changeAnimation('estrella');
  }
}
